...
<head>
    ...
    <div style="background-image: url(http://i.imgur.com/4Ro2vCe.jpg); height: 880px; background-size: cover;">

        <div class="container" style="top: 150px;">

            <form method="post" action="addfavoriteartdb.php">
                ...
                <div class="row">
                    ...
                    <div class="six columns">
                        ...
                        <input class="u-full-width" type="text" placeholder="Untitled" id="Title" name="Title">
                ...
                <div class="row">
                    ...
                    <div class="six columns">
                        ...
                        <label for="Artist">
                            ...
                            <input class="u-full-width" type="text" placeholder="Unknown" id="Artist"
                               name="Artist">
