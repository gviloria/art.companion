...
<head>
    ...
    <div style="width: 1440px; position:absolute; left: 90px; background-color: white;">
        <table class="u-full-width">
            ...
            while ($i < $num) {
                ...
                echo '<tr>';
                echo '<th style="text-align: center;"><img src="' . $picture . '"height = "200"/></th>';
                echo '<th style="font-style: italic;">' . $artist . '</th>';
                echo '<th>' . $website . '</th>';
                echo '<th><a class="button" href="editartist.php?id=' . $id . '">Edit</a></th>';
                echo '<th><a class="button" href="deleteartistdb.php?id=' . $id . '">Delete</a></th>';
                echo '</tr>';
